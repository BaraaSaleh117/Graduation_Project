...
class PushUp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyAqla(title: 'Push Up'),
    );
  }
}
...
class _MyAqla extends State<MyAqla> {
  ...
  Widget build(BuildContext context) {
    ...
    const String toLaunch1 =
        'https://www.youtube.com/watch?v=7ODJboTuANY&ab_channel=BullyJuice';
    const String toLaunch2 =
        'https://www.youtube.com/watch?v=Pp44Y390Ffs&ab_channel=BullyJuice';
    const String toLaunch3 =
        'https://www.youtube.com/watch?v=m1W1BGpPGMo&ab_channel=Calisthenicmovement';
    return Scaffold(
        appBar: AppBar(
        ...
        body: Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
                image: AssetImage("lib/assets/oqp.jpg"), fit: BoxFit.cover),
          ),
          child: ListView(
            children: <Widget>[
              SizedBox(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      " Push-ups are a good exercise and an option for diabetics" +
                          "\n" +
                          "\n" +
