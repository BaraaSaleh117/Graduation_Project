...
class BikeRiding extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyAqla(title: 'Bike riding'),
    );
  }
}
...
class _MyAqla extends State<MyAqla> {
  ...
  Widget build(BuildContext context) {
    ...
    const String toLaunch1 =
        'https://www.youtube.com/watch?v=wBurKQX7h4Q&ab_channel=GlobalCyclingNetwork';
    const String toLaunch2 =
        'https://www.youtube.com/watch?v=ewrf_rCHUdA&ab_channel=GCNTraining';
        ...
        body: Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
                image: AssetImage("lib/assets/bi.jpg"), fit: BoxFit.cover),
          ),
          child: ListView(
            children: <Widget>[
              SizedBox(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      " Cycling is an excellent exercise for diabetics" +
                          "\n" +
                          "\n" +
                    ...
                    Link(
                      uri: Uri.parse(
                          'https://link.springer.com/article/10.1007/s40279-021-01610-x'),
              ...
              Container(
                  ...
                  child: Column(
                    children: [
                      Text(
                        "Recommended time : 25 Minutes / day",
                        style: TextStyle(
